...
export default function Footer() {
  ...
  // LinkedIn & YouTube tetap ada di kode (tidak dihapus), tapi di-set active: false
  const socialLinks = [
    { 
      icon: Github, 
    ...
    { 
      ...
      href: '#', 
      label: 'LinkedIn', 
      active: false, // Disimpan di kode, tapi tidak muncul di web
    ...
    <footer className="relative py-24 overflow-hidden transition-colors duration-700
      ...
      <div className="container mx-auto px-6 relative z-10 pt-16">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          {/* 3. SOCIAL LINKS SECTION (Filtered) */}
          <motion.div
          ...
          >
            {/* Hanya menampilkan link yang statusnya active: true */}
            {socialLinks
